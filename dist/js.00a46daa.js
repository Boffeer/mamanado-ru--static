...
},{}],"../node_modules/vanillajs-datepicker/js/lib/date.js":[function(require,module,exports) {
"use strict";
...
},{}],"../node_modules/vanillajs-datepicker/js/lib/date-format.js":[function(require,module,exports) {
"use strict";
...
exports.reNonDateParts = exports.reFormatTokens = void 0;
...
exports.reFormatTokens = reFormatTokens;
const reNonDateParts = /[\s!-/:-@[-`{-~年月日]+/; // cache for persed formats

exports.reNonDateParts = reNonDateParts;
...
function parseFormatString(format) {
  ...
  return knownFormats[format] = {
    ...
    formatter(date, locale) {
      ...
      return dateStr += (0, _utils.lastItemOf)(separators);
    }
...
function parseDate(dateStr, format, locale) {
  if (dateStr instanceof Date || typeof dateStr === 'number') {
    const date = (0, _date.stripTime)(dateStr);
  ...
  if (dateStr === 'today') {
    return (0, _date.today)();
  }

  if (format && format.toValue) {
    const date = format.toValue(dateStr, format, locale);
    return isNaN(date) ? undefined : (0, _date.stripTime)(date);
  }
...
},{"./date.js":"../node_modules/vanillajs-datepicker/js/lib/date.js","./utils.js":"../node_modules/vanillajs-datepicker/js/lib/utils.js"}],"../node_modules/vanillajs-datepicker/js/lib/dom.js":[function(require,module,exports) {
"use strict";
...
},{}],"../node_modules/vanillajs-datepicker/js/lib/event.js":[function(require,module,exports) {
"use strict";
...
},{}],"../node_modules/vanillajs-datepicker/js/i18n/base-locales.js":[function(require,module,exports) {
"use strict";
...
},{}],"../node_modules/vanillajs-datepicker/js/options/defaultOptions.js":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
},{}],"../node_modules/vanillajs-datepicker/js/options/processOptions.js":[function(require,module,exports) {
"use strict";
...
var _date = require("../lib/date.js");

var _dateFormat = require("../lib/date-format.js");
...
} = _defaultOptions.default; // Reducer function to filter out invalid day-of-week from the input

function sanitizeDOW(dow, day) {
  return dow.length < 6 && day >= 0 && day < 7 ? (0, _utils.pushUnique)(dow, day) : dow;
}
...
function validateDate(value, format, locale, origValue) {
  const date = (0, _dateFormat.parseDate)(value, format, locale);
...
function processOptions(options, datepicker) {
  ...
  if (inOpts.format) {
    ...
    const validFormatString = _dateFormat.reFormatTokens.test(inOpts.format);
  ...
  if (inOpts.maxDate !== undefined) {
    ...
    if (maxDt !== undefined) {
      maxDt = (0, _date.regularizeDate)(maxDt, pickLevel, true);
    }
  ...
  if (inOpts.datesDisabled) {
    config.datesDisabled = inOpts.datesDisabled.reduce((dates, dt) => {
      const date = (0, _dateFormat.parseDate)(dt, format, locale);
      return date !== undefined ? (0, _utils.pushUnique)(dates, (0, _date.regularizeDate)(date, pickLevel, rangeSideIndex)) : dates;
    }, []);
    delete inOpts.datesDisabled;
  }

  if (inOpts.defaultViewDate !== undefined) {
    const viewDate = (0, _dateFormat.parseDate)(inOpts.defaultViewDate, format, locale);
  ...
  if (inOpts.prevArrow) {
    const prevArrow = (0, _dom.parseHTML)(inOpts.prevArrow);
  ...
  if (inOpts.nextArrow) {
    const nextArrow = (0, _dom.parseHTML)(inOpts.nextArrow);
  ...
  Object.keys(inOpts).forEach(key => {
    if (inOpts[key] !== undefined && (0, _utils.hasProperty)(_defaultOptions.default, key)) {
      config[key] = inOpts[key];
    }
  });
  return config;
}
},{"../lib/utils.js":"../node_modules/vanillajs-datepicker/js/lib/utils.js","../lib/date.js":"../node_modules/vanillajs-datepicker/js/lib/date.js","../lib/date-format.js":"../node_modules/vanillajs-datepicker/js/lib/date-format.js","../lib/dom.js":"../node_modules/vanillajs-datepicker/js/lib/dom.js","./defaultOptions.js":"../node_modules/vanillajs-datepicker/js/options/defaultOptions.js"}],"../node_modules/vanillajs-datepicker/js/picker/templates/pickerTemplate.js":[function(require,module,exports) {
"use strict";
...
const pickerTemplate = (0, _utils.optimizeTemplateHTML)(`<div class="datepicker">
...
var _default = pickerTemplate;
exports.default = _default;
},{"../../lib/utils.js":"../node_modules/vanillajs-datepicker/js/lib/utils.js"}],"../node_modules/vanillajs-datepicker/js/picker/templates/daysTemplate.js":[function(require,module,exports) {
"use strict";
...
const daysTemplate = (0, _utils.optimizeTemplateHTML)(`<div class="days">
  <div class="days-of-week">${(0, _utils.createTagRepeat)('span', 7, {
  class: 'dow'
})}</div>
  <div class="datepicker-grid">${(0, _utils.createTagRepeat)('span', 42)}</div>
</div>`);
var _default = daysTemplate;
exports.default = _default;
},{"../../lib/utils.js":"../node_modules/vanillajs-datepicker/js/lib/utils.js"}],"../node_modules/vanillajs-datepicker/js/picker/templates/calendarWeeksTemplate.js":[function(require,module,exports) {
"use strict";
...
const calendarWeeksTemplate = (0, _utils.optimizeTemplateHTML)(`<div class="calendar-weeks">
  <div class="days-of-week"><span class="dow"></span></div>
  <div class="weeks">${(0, _utils.createTagRepeat)('span', 6, {
  class: 'week'
})}</div>
</div>`);
var _default = calendarWeeksTemplate;
exports.default = _default;
},{"../../lib/utils.js":"../node_modules/vanillajs-datepicker/js/lib/utils.js"}],"../node_modules/vanillajs-datepicker/js/picker/views/View.js":[function(require,module,exports) {
"use strict";
...
class View {
  constructor(picker, config) {
    Object.assign(this, config, {
      picker,
      element: (0, _dom.parseHTML)(`<div class="datepicker-view"></div>`).firstChild,
      selected: []
    });
  ...
  performBeforeHook(el, current, timeValue) {
    ...
    if (result) {
      if (result.enabled === false) {
        ...
        (0, _utils.pushUnique)(this.disabled, current);
      }
      ...
      if (result.content) {
        (0, _dom.replaceChildNodes)(el, result.content);
      }
    }
  }
...
},{"../../lib/utils.js":"../node_modules/vanillajs-datepicker/js/lib/utils.js","../../lib/dom.js":"../node_modules/vanillajs-datepicker/js/lib/dom.js"}],"../node_modules/vanillajs-datepicker/js/picker/views/DaysView.js":[function(require,module,exports) {
"use strict";
...
var _daysTemplate = _interopRequireDefault(require("../templates/daysTemplate.js"));

var _calendarWeeksTemplate = _interopRequireDefault(require("../templates/calendarWeeksTemplate.js"));

var _View = _interopRequireDefault(require("./View.js"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

class DaysView extends _View.default {
  constructor(picker) {
    super(picker, {
      id: 0,
      name: 'days',
  ...
  init(options, onConstruction = true) {
    if (onConstruction) {
      const inner = (0, _dom.parseHTML)(_daysTemplate.default).firstChild;
  ...
  setOptions(options) {
    ...
    if ((0, _utils.hasProperty)(options, 'minDate')) {
      this.minDate = options.minDate;
    }

    if ((0, _utils.hasProperty)(options, 'maxDate')) {
    ...
    if (options.calendarWeeks !== undefined) {
      if (options.calendarWeeks && !this.calendarWeeks) {
        const weeksElem = (0, _dom.parseHTML)(_calendarWeeksTemplate.default).firstChild;
        this.calendarWeeks = {
          element: weeksElem,
    ...
    if (options.showDaysOfWeek !== undefined) {
      if (options.showDaysOfWeek) {
        (0, _dom.showElement)(this.dow);

        if (this.calendarWeeks) {
          (0, _dom.showElement)(this.calendarWeeks.dow);
        }
      } else {
        (0, _dom.hideElement)(this.dow);

        if (this.calendarWeeks) {
          (0, _dom.hideElement)(this.calendarWeeks.dow);
        }
      }
  ...
  updateFocus() {
    ...
    const firstOfMonth = (0, _date.dateValue)(viewYear, viewMonth, 1);
    const start = (0, _date.dayOfTheWeekOf)(firstOfMonth, this.weekStart, this.weekStart);
    this.first = firstOfMonth;
    this.last = (0, _date.dateValue)(viewYear, viewMonth + 1, 0);
    this.start = start;
  ...
  render() {
    ...
    this.today = this.todayHighlight ? (0, _date.today)() : undefined; // refresh disabled dates on every render in order to clear the ones added
    // by beforeShow hook at previous render

    this.disabled = [...this.datesDisabled];
    const switchLabel = (0, _dateFormat.formatDate)(this.focused, this.switchLabelFormat, this.locale);
    ...
    if (this.calendarWeeks) {
      ...
      const startOfWeek = (0, _date.dayOfTheWeekOf)(this.first, 1, 1);
      Array.from(this.calendarWeeks.weeks.children).forEach((el, index) => {
        el.textContent = (0, _date.getWeek)((0, _date.addWeeks)(startOfWeek, index));
      });
    }

    Array.from(this.grid.children).forEach((el, index) => {
      const classList = el.classList;
      const current = (0, _date.addDays)(this.start, index);
...
},{"../../lib/utils.js":"../node_modules/vanillajs-datepicker/js/lib/utils.js","../../lib/date.js":"../node_modules/vanillajs-datepicker/js/lib/date.js","../../lib/date-format.js":"../node_modules/vanillajs-datepicker/js/lib/date-format.js","../../lib/dom.js":"../node_modules/vanillajs-datepicker/js/lib/dom.js","../templates/daysTemplate.js":"../node_modules/vanillajs-datepicker/js/picker/templates/daysTemplate.js","../templates/calendarWeeksTemplate.js":"../node_modules/vanillajs-datepicker/js/picker/templates/calendarWeeksTemplate.js","./View.js":"../node_modules/vanillajs-datepicker/js/picker/views/View.js"}],"../node_modules/vanillajs-datepicker/js/picker/views/MonthsView.js":[function(require,module,exports) {
"use strict";
...
class MonthsView extends _View.default {
  constructor(picker) {
    super(picker, {
      id: 1,
      name: 'months',
  ...
  init(options, onConstruction = true) {
    if (onConstruction) {
      ...
      this.grid.appendChild((0, _dom.parseHTML)((0, _utils.createTagRepeat)('span', 12, {
        'data-month': ix => ix
      })));
    }
  ...
  setOptions(options) {
    ...
    if ((0, _utils.hasProperty)(options, 'maxDate')) {
      if (options.maxDate === undefined) {
        ...
        this.maxDate = (0, _date.dateValue)(this.maxYear, this.maxMonth + 1, 0);
      }
    }
  ...
  updateSelection() {
    ...
    this.selected = dates.reduce((selected, timeValue) => {
      ...
      if (selected[year] === undefined) {
        ...
        (0, _utils.pushUnique)(selected[year], month);
      }
  ...
  render() {
    ...
    Array.from(this.grid.children).forEach((el, index) => {
      const classList = el.classList;
      const date = (0, _date.dateValue)(this.year, index, 1);
      el.className = `datepicker-cell ${this.cellClass}`;
...
},{"../../lib/utils.js":"../node_modules/vanillajs-datepicker/js/lib/utils.js","../../lib/date.js":"../node_modules/vanillajs-datepicker/js/lib/date.js","../../lib/dom.js":"../node_modules/vanillajs-datepicker/js/lib/dom.js","./View.js":"../node_modules/vanillajs-datepicker/js/picker/views/View.js"}],"../node_modules/vanillajs-datepicker/js/picker/views/YearsView.js":[function(require,module,exports) {
"use strict";
...
class YearsView extends _View.default {
  constructor(picker, config) {
    super(picker, config);
  }
  ...
  setOptions(options) {
    if ((0, _utils.hasProperty)(options, 'minDate')) {
      if (options.minDate === undefined) {
        ...
        this.minYear = (0, _date.startOfYearPeriod)(options.minDate, this.step);
        this.minDate = (0, _date.dateValue)(this.minYear, 0, 1);
      }
    }
    ...
    if ((0, _utils.hasProperty)(options, 'maxDate')) {
      if (options.maxDate === undefined) {
        ...
        this.maxYear = (0, _date.startOfYearPeriod)(options.maxDate, this.step);
        this.maxDate = (0, _date.dateValue)(this.maxYear, 11, 31);
      }
    }
  ...
  updateFocus() {
    const viewDate = new Date(this.picker.viewDate);
    const first = (0, _date.startOfYearPeriod)(viewDate, this.navStep);
    const last = first + 9 * this.step;
    this.first = first;
    this.last = last;
    this.start = first - this.step;
    this.focused = (0, _date.startOfYearPeriod)(viewDate, this.step);
  } // Update view's settings to reflect the selected dates
  ...
  updateSelection() {
    ...
    this.selected = dates.reduce((years, timeValue) => {
      return (0, _utils.pushUnique)(years, (0, _date.startOfYearPeriod)(timeValue, this.step));
    }, []);

    if (rangepicker && rangepicker.dates) {
      this.range = rangepicker.dates.map(timeValue => {
        if (timeValue !== undefined) {
          return (0, _date.startOfYearPeriod)(timeValue, this.step);
        }
      });
    }
  } // Update the entire view UI
  ...
  render() {
    ...
    Array.from(this.grid.children).forEach((el, index) => {
      ...
      const date = (0, _date.dateValue)(current, 0, 1);
      el.className = `datepicker-cell ${this.cellClass}`;
...
},{"../../lib/utils.js":"../node_modules/vanillajs-datepicker/js/lib/utils.js","../../lib/date.js":"../node_modules/vanillajs-datepicker/js/lib/date.js","../../lib/dom.js":"../node_modules/vanillajs-datepicker/js/lib/dom.js","./View.js":"../node_modules/vanillajs-datepicker/js/picker/views/View.js"}],"../node_modules/vanillajs-datepicker/js/events/functions.js":[function(require,module,exports) {
"use strict";
...
function goToPrevOrNext(datepicker, direction) {
  ...
  switch (currentView.id) {
    case 0:
      newViewDate = (0, _date.addMonths)(viewDate, direction);
      break;

    case 1:
      newViewDate = (0, _date.addYears)(viewDate, direction);
      break;

    default:
      newViewDate = (0, _date.addYears)(viewDate, direction * currentView.navStep);
  }

  newViewDate = (0, _utils.limitToRange)(newViewDate, minDate, maxDate);
...
},{"../lib/utils.js":"../node_modules/vanillajs-datepicker/js/lib/utils.js","../lib/date.js":"../node_modules/vanillajs-datepicker/js/lib/date.js"}],"../node_modules/vanillajs-datepicker/js/events/pickerListeners.js":[function(require,module,exports) {
"use strict";
...
exports.onMousedownPicker = onMousedownPicker;
...
function goToSelectedMonthOrYear(datepicker, selection) {
  ...
  const newDate = viewId === 1 ? (0, _date.addMonths)(viewDate, selection - viewDate.getMonth()) : (0, _date.addYears)(viewDate, selection - viewDate.getFullYear());
  picker.changeFocus(newDate).changeView(viewId - 1).render();
}

function onClickTodayBtn(datepicker) {
  const picker = datepicker.picker;
  const currentDate = (0, _date.today)();
...
function onClickViewSwitch(datepicker) {
  (0, _functions.switchView)(datepicker);
}

function onClickPrevBtn(datepicker) {
  (0, _functions.goToPrevOrNext)(datepicker, -1);
}
...
function onClickView(datepicker, ev) {
  const target = (0, _event.findElementInEventPath)(ev, '.datepicker-cell');
...
},{"../lib/date.js":"../node_modules/vanillajs-datepicker/js/lib/date.js","../lib/event.js":"../node_modules/vanillajs-datepicker/js/lib/event.js","./functions.js":"../node_modules/vanillajs-datepicker/js/events/functions.js"}],"../node_modules/vanillajs-datepicker/js/picker/Picker.js":[function(require,module,exports) {
"use strict";
...
var _pickerTemplate = _interopRequireDefault(require("./templates/pickerTemplate.js"));

var _DaysView = _interopRequireDefault(require("./views/DaysView.js"));

var _MonthsView = _interopRequireDefault(require("./views/MonthsView.js"));

var _YearsView = _interopRequireDefault(require("./views/YearsView.js"));

var _functions = require("../events/functions.js");

var _pickerListeners = require("../events/pickerListeners.js");
...
function processPickerOptions(picker, options) {
  if (options.title !== undefined) {
    if (options.title) {
      ...
      (0, _dom.showElement)(picker.controls.title);
    } else {
      picker.controls.title.textContent = '';
      (0, _dom.hideElement)(picker.controls.title);
    }
  }

  if (options.prevArrow) {
    const prevBtn = picker.controls.prevBtn;
    (0, _dom.emptyChildNodes)(prevBtn);
  ...
  if (options.nextArrow) {
    ...
    (0, _dom.emptyChildNodes)(nextBtn);
  ...
  if (options.todayBtn !== undefined) {
    if (options.todayBtn) {
      (0, _dom.showElement)(picker.controls.todayBtn);
    } else {
      (0, _dom.hideElement)(picker.controls.todayBtn);
    }
  }

  if ((0, _utils.hasProperty)(options, 'minDate') || (0, _utils.hasProperty)(options, 'maxDate')) {
    const {
      minDate,
      maxDate
    } = picker.datepicker.config;
    picker.controls.todayBtn.disabled = !(0, _utils.isInRange)((0, _date.today)(), minDate, maxDate);
  }

  if (options.clearBtn !== undefined) {
    if (options.clearBtn) {
      (0, _dom.showElement)(picker.controls.clearBtn);
    } else {
      (0, _dom.hideElement)(picker.controls.clearBtn);
    }
  }
...
function computeResetViewDate(datepicker) {
  ...
  const viewDate = dates.length > 0 ? (0, _utils.lastItemOf)(dates) : config.defaultViewDate;
  return (0, _utils.limitToRange)(viewDate, config.minDate, config.maxDate);
...
function setViewDate(picker, newDate) {
  ...
  if (viewYear !== oldViewDate.getFullYear()) {
    (0, _functions.triggerDatepickerEvent)(picker.datepicker, 'changeYear');
  }

  if (newViewDate.getMonth() !== oldViewDate.getMonth()) {
    (0, _functions.triggerDatepickerEvent)(picker.datepicker, 'changeMonth');
...
function findScrollParents(el) {
  const parent = (0, _dom.getParent)(el);
...
class Picker {
  constructor(datepicker) {
    ...
    const template = _pickerTemplate.default.replace(/%buttonClass%/g, config.buttonClass);

    const element = this.element = (0, _dom.parseHTML)(template).firstChild;
    ...
    (0, _event.registerListeners)(datepicker, [[element, 'mousedown', _pickerListeners.onMousedownPicker], [main, 'click', _pickerListeners.onClickView.bind(null, datepicker)], [controls.viewSwitch, 'click', _pickerListeners.onClickViewSwitch.bind(null, datepicker)], [controls.prevBtn, 'click', _pickerListeners.onClickPrevBtn.bind(null, datepicker)], [controls.nextBtn, 'click', _pickerListeners.onClickNextBtn.bind(null, datepicker)], [controls.todayBtn, 'click', _pickerListeners.onClickTodayBtn.bind(null, datepicker)], [controls.clearBtn, 'click', _pickerListeners.onClickClearBtn.bind(null, datepicker)]]); // set up views

    this.views = [new _DaysView.default(this), new _MonthsView.default(this), new _YearsView.default(this, {
      id: 2,
      name: 'years',
      cellClass: 'year',
      step: 1
    }), new _YearsView.default(this, {
      id: 3,
      name: 'decades',
      cellClass: 'decade',
      step: 10
  ...
  show() {
    ...
    if (datepicker.inline) {
      ...
      if (inputDirection !== getTextDirection((0, _dom.getParent)(element))) {
    ...
    this.active = true;
    (0, _functions.triggerDatepickerEvent)(datepicker, 'show');
  }
  ...
  hide() {
    ...
    this.active = false;
    (0, _functions.triggerDatepickerEvent)(this.datepicker, 'hide');
  }
  ...
  changeView(viewId) {
    ...
    if (newView.id !== oldView.id) {
      ...
      (0, _functions.triggerDatepickerEvent)(this.datepicker, 'changeView');
...
},{"../lib/utils.js":"../node_modules/vanillajs-datepicker/js/lib/utils.js","../lib/date.js":"../node_modules/vanillajs-datepicker/js/lib/date.js","../lib/dom.js":"../node_modules/vanillajs-datepicker/js/lib/dom.js","../lib/event.js":"../node_modules/vanillajs-datepicker/js/lib/event.js","./templates/pickerTemplate.js":"../node_modules/vanillajs-datepicker/js/picker/templates/pickerTemplate.js","./views/DaysView.js":"../node_modules/vanillajs-datepicker/js/picker/views/DaysView.js","./views/MonthsView.js":"../node_modules/vanillajs-datepicker/js/picker/views/MonthsView.js","./views/YearsView.js":"../node_modules/vanillajs-datepicker/js/picker/views/YearsView.js","../events/functions.js":"../node_modules/vanillajs-datepicker/js/events/functions.js","../events/pickerListeners.js":"../node_modules/vanillajs-datepicker/js/events/pickerListeners.js"}],"../node_modules/vanillajs-datepicker/js/events/inputFieldListeners.js":[function(require,module,exports) {
"use strict";
...
function findNextAvailableOne(date, addFn, increase, testFn, min, max) {
  if (!(0, _utils.isInRange)(date, min, max)) {
    return;
  }
...
function moveByArrowKey(datepicker, ev, direction, vertical) {
  ...
  switch (currentView.id) {
    case 0:
      if (vertical) {
        viewDate = (0, _date.addDays)(viewDate, direction * 7);
      } else if (ev.ctrlKey || ev.metaKey) {
        viewDate = (0, _date.addYears)(viewDate, direction);
      } else {
        viewDate = (0, _date.addDays)(viewDate, direction);
      }
    ...
    case 1:
      viewDate = (0, _date.addMonths)(viewDate, vertical ? direction * 4 : direction);
      addFn = _date.addMonths;
    ...
    default:
      viewDate = (0, _date.addYears)(viewDate, direction * (vertical ? 4 : 1) * step);
      addFn = _date.addYears;

      testFn = date => currentView.disabled.includes((0, _date.startOfYearPeriod)(date, step));
...
function onKeydown(datepicker, ev) {
  ...
  if (key === 'Tab') {
    (0, _functions.unfocus)(datepicker);
    return;
  }
...
function onMousedown(datepicker, ev) {
  ...
  if (datepicker.picker.active || datepicker.config.showOnClick) {
    el._active = (0, _dom.isActiveElement)(el);
...
},{"../lib/utils.js":"../node_modules/vanillajs-datepicker/js/lib/utils.js","../lib/dom.js":"../node_modules/vanillajs-datepicker/js/lib/dom.js","../lib/date.js":"../node_modules/vanillajs-datepicker/js/lib/date.js","./functions.js":"../node_modules/vanillajs-datepicker/js/events/functions.js"}],"../node_modules/vanillajs-datepicker/js/events/otherListeners.js":[function(require,module,exports) {
"use strict";
...
function onClickOutside(datepicker, ev) {
  ...
  if (!picker.active && !(0, _dom.isActiveElement)(element)) {
    return;
  }

  const pickerElem = picker.element;

  if ((0, _event.findElementInEventPath)(ev, el => el === element || el === pickerElem)) {
    return;
  }

  (0, _functions.unfocus)(datepicker);
}
},{"../lib/dom.js":"../node_modules/vanillajs-datepicker/js/lib/dom.js","../lib/event.js":"../node_modules/vanillajs-datepicker/js/lib/event.js","./functions.js":"../node_modules/vanillajs-datepicker/js/events/functions.js"}],"../node_modules/vanillajs-datepicker/js/Datepicker.js":[function(require,module,exports) {
"use strict";
...
var _baseLocales = require("./i18n/base-locales.js");

var _defaultOptions = _interopRequireDefault(require("./options/defaultOptions.js"));

var _processOptions = _interopRequireDefault(require("./options/processOptions.js"));

var _Picker = _interopRequireDefault(require("./picker/Picker.js"));

var _functions = require("./events/functions.js");

var _inputFieldListeners = require("./events/inputFieldListeners.js");

var _otherListeners = require("./events/otherListeners.js");

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

function stringifyDates(dates, config) {
  return dates.map(dt => (0, _dateFormat.formatDate)(dt, config.format, config.locale)).join(config.dateDelimiter);
...
function processInputDates(datepicker, inputDates, clear = false) {
  ...
  let newDates = inputDates.reduce((dates, dt) => {
    let date = (0, _dateFormat.parseDate)(dt, config.format, config.locale);
    ...
    date = (0, _date.regularizeDate)(date, config.pickLevel, rangeSideIndex);

    if ((0, _utils.isInRange)(date, config.minDate, config.maxDate) && !dates.includes(date) && !config.datesDisabled.includes(date) && (config.pickLevel > 0 || !config.daysOfWeekDisabled.includes(new Date(date).getDay()))) {
      dates.push(date);
    }
...
function setDate(datepicker, inputDates, options) {
  ...
  if (newDates && newDates.toString() !== datepicker.dates.toString()) {
    ...
    (0, _functions.triggerDatepickerEvent)(datepicker, 'changeDate');
  } else {
...
class Datepicker {
  ...
  constructor(element, options = {}, rangepicker = undefined) {
    ...
    const config = this.config = Object.assign({
      ...
      container: null,
      defaultViewDate: (0, _date.today)(),
      maxDate: undefined,
      minDate: undefined
    }, (0, _processOptions.default)(_defaultOptions.default, this)); // configure by type
    ...
    Object.assign(config, (0, _processOptions.default)(options, this)); // set initial dates

    let initialDates;

    if (inline) {
      initialDates = (0, _utils.stringToArray)(element.dataset.date, config.dateDelimiter);
      delete element.dataset.date;
    } else {
      initialDates = (0, _utils.stringToArray)(inputField.value, config.dateDelimiter);
    }
    ...
    const picker = this.picker = new _Picker.default(this);

    if (inline) {
      this.show();
    } else {
      // set up event listeners in other modes
      const onMousedownDocument = _otherListeners.onClickOutside.bind(null, this);

      const listeners = [[inputField, 'keydown', _inputFieldListeners.onKeydown.bind(null, this)], [inputField, 'focus', _inputFieldListeners.onFocus.bind(null, this)], [inputField, 'mousedown', _inputFieldListeners.onMousedown.bind(null, this)], [inputField, 'click', _inputFieldListeners.onClickInput.bind(null, this)], [inputField, 'paste', _inputFieldListeners.onPaste.bind(null, this)], [document, 'mousedown', onMousedownDocument], [document, 'touchstart', onMousedownDocument], [window, 'resize', picker.place.bind(picker)]];
      (0, _event.registerListeners)(this, listeners);
    }
  }
  /**
  ...
  static formatDate(date, format, lang) {
    return (0, _dateFormat.formatDate)(date, format, lang && _baseLocales.locales[lang] || _baseLocales.locales.en);
  }
  /**
   * Parse date string
  ...
  static parseDate(dateStr, format, lang) {
    return (0, _dateFormat.parseDate)(dateStr, format, lang && _baseLocales.locales[lang] || _baseLocales.locales.en);
  }
  /**
  ...
  setOptions(options) {
    ...
    const newOptions = (0, _processOptions.default)(options, this);
  ...
  show() {
    if (this.inputField) {
      ...
      if (!(0, _dom.isActiveElement)(this.inputField) && !this.config.disableTouchKeyboard) {
        this._showing = true;
  ...
  destroy() {
    this.hide();
    (0, _event.unregisterListeners)(this);
    this.picker.detach();
  ...
  getDate(format = undefined) {
    const callback = format ? date => (0, _dateFormat.formatDate)(date, format, this.config.locale) : date => new Date(date);
  ...
  setDate(...args) {
    const dates = [...args];
    const opts = {};
    const lastArg = (0, _utils.lastItemOf)(args);
  ...
  update(options = undefined) {
    ...
    const inputDates = (0, _utils.stringToArray)(this.inputField.value, this.config.dateDelimiter);
    setDate(this, inputDates, opts);
  }
  /**
...
},{"./lib/utils.js":"../node_modules/vanillajs-datepicker/js/lib/utils.js","./lib/date.js":"../node_modules/vanillajs-datepicker/js/lib/date.js","./lib/date-format.js":"../node_modules/vanillajs-datepicker/js/lib/date-format.js","./lib/dom.js":"../node_modules/vanillajs-datepicker/js/lib/dom.js","./lib/event.js":"../node_modules/vanillajs-datepicker/js/lib/event.js","./i18n/base-locales.js":"../node_modules/vanillajs-datepicker/js/i18n/base-locales.js","./options/defaultOptions.js":"../node_modules/vanillajs-datepicker/js/options/defaultOptions.js","./options/processOptions.js":"../node_modules/vanillajs-datepicker/js/options/processOptions.js","./picker/Picker.js":"../node_modules/vanillajs-datepicker/js/picker/Picker.js","./events/functions.js":"../node_modules/vanillajs-datepicker/js/events/functions.js","./events/inputFieldListeners.js":"../node_modules/vanillajs-datepicker/js/events/inputFieldListeners.js","./events/otherListeners.js":"../node_modules/vanillajs-datepicker/js/events/otherListeners.js"}],"../node_modules/vanillajs-datepicker/js/DateRangePicker.js":[function(require,module,exports) {
"use strict";
...
function setupDatepicker(rangepicker, changeDateListener, el, options) {
  (0, _event.registerListeners)(rangepicker, [[el, 'changeDate', changeDateListener]]);
  new _Datepicker.default(el, options, rangepicker);
}
...
class DateRangePicker {
  ...
  getDates(format = undefined) {
    const callback = format ? date => (0, _dateFormat.formatDate)(date, format, this.datepickers[0].config.locale) : date => new Date(date);
...
},{"./lib/event.js":"../node_modules/vanillajs-datepicker/js/lib/event.js","./lib/date-format.js":"../node_modules/vanillajs-datepicker/js/lib/date-format.js","./Datepicker.js":"../node_modules/vanillajs-datepicker/js/Datepicker.js"}],"../node_modules/vanillajs-datepicker/js/main.js":[function(require,module,exports) {
"use strict";
...
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
},{"./Datepicker.js":"../node_modules/vanillajs-datepicker/js/Datepicker.js","./DateRangePicker.js":"../node_modules/vanillajs-datepicker/js/DateRangePicker.js"}],"../node_modules/vanillajs-datepicker/js/i18n/locales/ru.js":[function(require,module,exports) {
"use strict";
...
var _ru = _interopRequireDefault(require("vanillajs-datepicker/js/i18n/locales/ru.js"));

var _featuredSliderOption;
...
var searchButton = document.querySelector(".header-userbar__item--search");
...
_swiper.default.use([_swiper.Navigation, _swiper.Autoplay, _swiper.Pagination]);

var headerStocks = new _swiper.default(".header-stocks", {
  grabCursor: true,
  effect: "creative",
  creativeEffect: {
    prev: {
...
var offersSlider = new _swiper.default(".offers-slider", {
  a11y: {
    enabled: false
  },
  effect: "creative",
...
var featuredSliderOptions = (_featuredSliderOption = {
  allowTouchMove: false,
  spaceBetween: 0,
  slidesPerView: 2,
  grabCursor: true
}, _defineProperty(_featuredSliderOption, "slidesPerView", "auto"), _defineProperty(_featuredSliderOption, "navigation", {
  nextEl: ".featured__button-next",
  prevEl: ".featured__button-prev"
}), _defineProperty(_featuredSliderOption, "breakpoints", {
...
}), _featuredSliderOption);
var featuresSlider = new _swiper.default(".featured-slider", featuredSliderOptions);
var featuredSliderElement = document.querySelector(".featured-slider");

if (featuredSliderElement) {
  var featuredSliderWrapper = featuredSliderElement.querySelector(".swiper-wrapper");
  var featuredSliderSlides = featuredSliderElement.querySelectorAll(".swiper-slide");
  ...
  function recalculateFeaturedSlider() {
    setTimeout(function () {
      if (window.innerWidth < 576) {
        ...
        featuredSliderSlides.forEach(function (slide) {
        ...
        featuresSlider = new _swiper.default(".featured-slider", featuredSliderOptions);
      }
  ...
  window.addEventListener("resize", function () {
    return recalculateFeaturedSlider();
  });
  recalculateFeaturedSlider();
}

var partnersSlider = new _swiper.default(".partners-slider", {
  slidesPerView: 2,
  slidesPerGroup: 2,
  spaceBetween: 14,
  grabCursor: true,
...
var yMapHrefBegin = "https://yandex.ru/maps/?";
var yMapHrefEnd = "&amp;source=constructorStatic";
var yMapImgBegin = "https://api-maps.yandex.ru/services/constructor/1.0/static/?";
var yMapImgEnd = "&amp;width=600&amp;height=450&amp;lang=ru_RU";
var yMapIframeBegin = "https://api-maps.yandex.ru/services/constructor/1.0/js/?";
var yMapIframeEnd = "&source=constructor&width=100%25&height=450&lang=ru_RU&scroll=true";
var yMapIframeEndSrc = "&source=constructor";

var mapsButtons = _toConsumableArray(document.querySelectorAll(".shop-addresses__item"));

var mapsIds = mapsButtons.map(function (mapButton) {
  var mapUrl = mapButton.getAttribute("data-address-map");
  mapUrl = mapUrl.replace(yMapIframeBegin, "");
  return mapUrl.replace(yMapIframeEnd, "");
});
var mapsIframes = mapsIds.map(function (map) {
  return "https://yandex.ru/map-widget/v1/?".concat(map).concat(yMapIframeEndSrc);
});
var shopsSection = document.querySelector(".shops");

if (shopsSection) {
  var shopsPlaceholder = document.querySelector(".shops__map-placeholder");
  var shopsIframe = document.querySelector(".shops__map-iframe");
  var isPlaceholderLoaded = false;
  var placeholderSrc = yMapImgBegin + mapsIds[0] + yMapImgEnd;
  window.addEventListener("scroll", function () {
    if (isPlaceholderLoaded) return;
    var pixlesUntill = shopsSection.getBoundingClientRect().top;
    if (pixlesUntill > 1000) return;
    isPlaceholderLoaded = true;
    shopsPlaceholder.setAttribute("src", placeholderSrc);
  });
  mapsButtons.forEach(function (button, index) {
    button.addEventListener("click", function () {
      if (button.classList.contains("shops-addresses--active")) return;
      mapsButtons.forEach(function (button) {
      ...
      var iframeSrc = mapsIframes[index];
      shopsIframe.setAttribute("src", iframeSrc);
    });
    var href = yMapHrefBegin + mapsIds[index] + yMapIframeEnd;
    button.querySelector(".shops-addresses__location").setAttribute("href", href);
  });
  var mapOptions = {
    once: true,
    //запуск один раз, и удаление наблюдателя сразу
    passive: true,
    capture: true
  };
...
var steppers = document.querySelectorAll(".control-stepper");

if (steppers) {
  steppers.forEach(function (stepper) {
    var minus = stepper.querySelector(".control-stepper__minus ");
    var input = stepper.querySelector(".control-stepper__input ");
    var plus = stepper.querySelector(".control-stepper__plus ");
    var inputMinExtremum = +input.getAttribute("data-min");
    var inputMaxExtremum = +input.getAttribute("data-max");
    var isMinusDisabled = false;
    var isPlusDisabled = false;
...
if (inputFields) {
  ...
  inputFields.forEach(function (input) {
    var placeholder = input.parentElement.querySelector(".input__placeholder");
    ...
    if (placeholder) {
      input.addEventListener("blur", function () {
        return checkInputContent(input, placeholder);
      });
...
var filterVisibilityTogglers = document.querySelectorAll(".filter__button-toggle");
var filterBlock = document.querySelector(".filter");

if (filterVisibilityTogglers) {
  filterVisibilityTogglers.forEach(function (button) {
    button.addEventListener("click", function () {
...
var scrollToTopButton = document.querySelector(".button__scroll-top");
...
var calendarInputs = document.querySelectorAll(".input--calendar");

if (calendarInputs) {
  calendarInputs.forEach(function (calendar) {
    var datepicker = new _vanillajsDatepicker.Datepicker(calendar, {
      format: "dd M. yyyy",
      autohide: true,
      maxDate: new Date(),
      language: "ru"
  ...
  phones.forEach(function (phone) {
    ...
    phone.addEventListener("click", function (event) {
      if (window.innerWidth > 1199) {
        ...
        textArea.remove();
        var phoneNummber = phone.innerText;
        var copiedLabel = phone.getAttribute("data-label");
...
window.addEventListener("DOMContentLoaded", function (event) {
  var headerTabs = document.querySelector(".header-nav__tabs");
  headerTabs.classList.remove("header-nav__tabs--loading");
});
},{"swiper":"../node_modules/swiper/swiper.esm.js","vanillajs-datepicker":"../node_modules/vanillajs-datepicker/js/main.js","vanillajs-datepicker/js/i18n/locales/ru.js":"../node_modules/vanillajs-datepicker/js/i18n/locales/ru.js"}],"../../../../Apps/Openserver/OSPanel/domains/mamanado.ru.loc/mamanado-ru--static/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../../../../Apps/Openserver/OSPanel/domains/mamanado.ru.loc/mamanado-ru--static/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/index.js"], null)
