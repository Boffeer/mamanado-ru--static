...
_swiper.default.use([_swiper.Navigation, _swiper.Autoplay, _swiper.Pagination, _swiper.Thumbs]);

var productThumbnails = new _swiper.default(".proudct-details-thumbnails", {
  // slidesPerView: "auto",
  slidesPerView: 4,
  spaceBetween: 15,
  grabCursor: true,
...
var productGallery = new _swiper.default(".product-detail-gallery", {
  grabCursor: true,
  effect: "creative",
  creativeEffect: {
    prev: {
...
var thumbsSlides = _toConsumableArray(document.querySelectorAll(".proudct-details-thumbnails__slide"));

var thumbsSlideActiveClass = "proudct-details-thumbnails__slide--active";
...
function handleThumbsSlideChange() {
  ...
  thumbsSlides[productThumbnails.activeIndex].classList.add(thumbsSlideActiveClass);
}
...
var productTabButtons = document.querySelectorAll(".product-details__taber");
var productTabs = document.querySelectorAll(".product-details__tab");
productTabButtons.forEach(function (button) {
  var tabButtonName = button.getAttribute("data-tab");
...
},{"swiper":"../node_modules/swiper/swiper.esm.js"}],"../../../../Apps/Openserver/OSPanel/domains/mamanado.ru.loc/mamanado-ru--static/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../../../../Apps/Openserver/OSPanel/domains/mamanado.ru.loc/mamanado-ru--static/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/product-page.js"], null)
//# sourceMappingURL=/product-page.adb0957a.js.map